	...
	const std::string& version)
{
	...
	{	_p->soap_default(soap);
		_p->ns1__ResponseType::greeting = greeting;
		_p->ns1__ResponseType::version = version;
	}
	return _p;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:ResponseType", p->soap_type() == SOAP_TYPE_ns1__ResponseType ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:ResponseType", p->soap_type() == SOAP_TYPE_ns1__ResponseType ? "" : NULL) || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns1__ResponseType(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
	...
	const std::string& input)
{
	...
	if (_p)
	{	_p->soap_default(soap);
		_p->ns1__RequestType::input = input;
	}
	return _p;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:RequestType", p->soap_type() == SOAP_TYPE_ns1__RequestType ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:RequestType", p->soap_type() == SOAP_TYPE_ns1__RequestType ? "" : NULL) || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns1__RequestType(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
